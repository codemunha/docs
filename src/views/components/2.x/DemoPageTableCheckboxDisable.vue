  ...
  <div>
    <DslCardExampleDemo :vertical="true" :header="header.main" :code="exampleCode1">
        ...
        <DslCollapse title="searchResult" :is-collapse="false">
          <template v-slot:body>
            ...
            <div class="remark-top">
              <code>
                Key: 'id'<br/>
                Disabled check list: {{ disabledCheckList }}<br/>
            ...
            <DslTableCustom
              ...
              key-attr="id" v-model="selectedData" :disabled-check-list="disabledCheckList">
      ...
      <template v-slot:desc>
        สร้าง computed <code>disabledCheckList</code> เช่นตัวอย่างต่อไปนี้:
        <pre class="language-js" v-html="html1"></pre>
        แล้ว set ผ่าน prop <code>disabled-check-list</code>
      </template>
    </DslCardExampleDemo>
  </div>
</template>
...
const SCRIPT = 'script'
export default {
  name: 'DemoPageTableCheckboxDisable',
  props: {
